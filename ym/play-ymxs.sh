...
# order, each named by its title, and the program picks between them on the
# keys 1 to 9. An SNDH file records one rate, so a multi whose tunes do not
# share one gets a line on stderr and no program.
#
