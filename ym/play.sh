...
#   -vbl       the VBL as the clock the program plays from, and -tc
#              Timer C, which -perf would otherwise name the VBL over
...
"$here/bin/ymxr-sndh" $perf $lean $clock $silent "-t${title:-$stem}" \
