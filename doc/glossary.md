...
| set bit | A column's top bit. It is 1 where the row sets that column, and the bits under a 0 hold nothing. A column with no bit to spare reserves a value instead. | requirements.md R3.6, R3.7 |
