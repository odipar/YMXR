...
| source | A table of `R` rows and `C` columns repeating at `RR`, advanced a row each tick, and typically one column of one byte. An effect's source column names one, 1 to 127. | SPEC.md 1.8, 2.2 |
