...
| table | What yields rows: `R` of them, `C` columns wide, repeating at `RR`. One that repeats yields rows without end. How its rows are laid out is the format's. | terminology.md, tables, rows and procedures |
